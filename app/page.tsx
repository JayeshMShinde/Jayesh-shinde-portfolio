    ...
    <div className="relative bg-gray-900">
      ...
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${
          scrolled
            ? "bg-gray-900/90 backdrop-blur-sm border-b border-blue-500/20"
            : "bg-transparent"
        }`}
      >
            ...
            <div className="hidden md:flex space-x-6">
              {navItems.map((item) => (
                <button
                  ...
                  className={`text-gray-300 hover:text-blue-400 px-3 py-2 rounded-md text-sm font-mono transition-colors duration-200 ${
      ...
      <main className="min-h-screen">
        ...
        {/* Contact Section */}
        <section id="contact" className="py-8 md:py-20 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <pre className="inline-block text-left bg-gray-800/50 p-4 md:p-8 rounded-lg border border-gray-700/50 overflow-x-auto w-full max-w-full">
              <code className="text-sm md:text-base text-gray-300 whitespace-pre-wrap break-words">
                ...
                <span className="text-orange-400">
                  &ldquo;{personalInfo.email}&rdquo;
                </span>
                ;
                <br />
                {"  "}
                ...
                <span className="text-orange-400">
                  &ldquo;{personalInfo.linkedin}&rdquo;
                </span>
                ;
                <br />
                {"  "}phone:{" "}
                <span className="text-orange-400">
                  &ldquo;{personalInfo.phone}&rdquo;
                </span>
                ;
                <br />
                {"  "}location:{" "}
                <span className="text-orange-400">
                  &ldquo;{personalInfo.location}&rdquo;
                </span>
                ;
                <br />
                {"  "}
                ...
                {"    "}status:{" "}
                <span className="text-orange-400">
                  &ldquo;Looking forward to connecting!&rdquo;
                </span>
                <br />
                {"  }"};
                <br />
            ...
            <div className="mt-4 md:mt-8 flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
              <a
                href={`mailto:${personalInfo.email}`}
                className="px-4 md:px-6 py-2 md:py-3 bg-blue-500 text-white text-sm md:text-base 
              rounded-md hover:bg-blue-600 transition-colors duration-200 flex items-center 
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 md:px-6 py-2 md:py-3 bg-gray-800 text-white text-sm md:text-base 
